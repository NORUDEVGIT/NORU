...
export const Route = createFileRoute("/confirmation")({
  head: () => ({
    meta: [
      { title: "Order Confirmed — The Garden Table" },
      { name: "description", content: "Your order has been sent to the kitchen at The Garden Table." },
      { property: "og:title", content: "Order Confirmed — The Garden Table" },
      ...
      <main className="fade-up mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <Button asChild size="lg" className="h-14 flex-1 rounded-full text-base">
            <Link to="/status">Track your order</Link>
          </Button>
          <Button
            asChild
            variant="outline"
