...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Order seasonal plates straight to your table at The Garden Table.",
      },
      { name: "author", content: "The Garden Table" },
      { property: "og:title", content: "The Garden Table" },
      {
