...
function ConfigurationRoute() {
  return <RestaurantShell active="Configuration">{(m) => <ConfigurationPage membership={m} />}</RestaurantShell>;
}
...
function ConfigurationPage({ membership }: { membership: RestaurantMembership }) {
