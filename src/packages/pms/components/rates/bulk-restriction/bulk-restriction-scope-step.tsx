  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-2">
        <div>
          <Label htmlFor="bulk-restriction-from">From</Label>
          <Input
        ...
        <div>
          <Label htmlFor="bulk-restriction-to">To</Label>
          <Input
      ...
      <p className="text-[10px] text-muted-foreground">
        Date range is not limited to the 14-day Restriction Calendar window. The wizard uses the full selected range.
      </p>
      ...
      {expansion.ok ? (
        ...
        <p className="text-[11px] text-[#6B4A0A]">{BULK_RESTRICTION_OVER_MAX_COPY}</p>
