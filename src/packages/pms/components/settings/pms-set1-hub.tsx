...
export function PmsSet1Hub({ membership }: { membership: RestaurantMembership }) {
  ...
  return (
    <div className="space-y-6" data-testid="pms-set1-hub">
      {card1Open || card2Open || card6Open ? null : (
      <div>
        <Link
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Property Setup for {membership.restaurant.name}. Eight cards. Property & Business, Rooms & Operations and Connectivity & Distribution are Spec’d in this wave.
        </p>
      </div>
      )}
