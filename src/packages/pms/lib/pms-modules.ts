...
export const PMS_MODULES: PmsModule[] = [
  ...
  },
  {
    key: "property-setup",
    title: "Settings",
    description: "Identity, check-in times, taxes, policies and go-live.",
    icon: SlidersHorizontal,
    group: "system",
    moduleKey: "configuration",
    canonicalRoute: "/restaurant/settings",
    legacyRoutes: ["/restaurant/pms/property-setup", "/restaurant/configuration"],
    domain: "pms",
    implementationStatus: "existing",
  },
  {
