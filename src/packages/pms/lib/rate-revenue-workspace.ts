...
export const REVENUE_VIEW_DEFINITIONS: RevenueViewDefinition[] = [
  ...
  },
  {
    ...
    implemented: false,
    plannedCapability: "Controlled bulk nightly-rate updates with review before apply.",
    sources: ["Property Setup", "Rate Calendar"],
    contextFields: ["dateRange", "roomType", "ratePlan"],
  },
  {
    id: "rate-history",
  ...
  },
  {
    ...
    implemented: false,
    plannedCapability: "Range application of operational restrictions with confirmation.",
    sources: ["Property Setup", "hotel_rate_restrictions"],
    contextFields: ["dateRange", "roomType", "ratePlan"],
  },
  {
    ...
    implemented: false,
    plannedCapability: "Immutable history of operational restriction rows.",
    sources: ["hotel_rate_restrictions"],
    contextFields: ["dateRange", "roomType", "ratePlan"],
  },
  {
    id: "demand-forecast",
    ...
    description: "Demand, pickup and forecast decision-support workspace.",
    implemented: false,
    plannedCapability: "Forward occupancy and revenue demand support for the revenue team.",
  ...
  },
  {
    ...
    label: "Pickup & Pace",
    section: "demand-forecast",
    description: "Compare booking pickup against expected pace.",
    implemented: false,
    plannedCapability: "Pickup and pace decision support from live reservations.",
  ...
  },
  {
    ...
    section: "demand-forecast",
    description: "Calendar view of demand pressure across stay dates.",
    implemented: false,
    plannedCapability: "Date-grid demand pressure from reservations and inventory.",
    sources: ["Reservations", "Rooms & Inventory"],
    contextFields: ["dateRange", "roomType", "ratePlan"],
  },
  {
...
export const REVENUE_UI_SCREEN_MAP: Array<{
  ...
  { ui: "UI-05", view: null, note: "future review/confirmation, not primary nav" },
  ...
  { ui: "UI-10", view: null, note: "future confirmation workflow" },
