...
describe("Guest Profile Wave 2 lock", () => {
  it("activates Identity and Preferences cards and keeps Waves 3–5 gated", () => {
    ...
    assert.equal(byId.get("stay-history")?.live, false);
    assert.equal(byId.get("dashboard")?.live, false);
