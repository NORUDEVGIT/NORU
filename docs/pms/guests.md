...
| Record | Role |
|---|---|
| [Functional Spec — Guest Profile Module](./specs/guest-profile-module.md) | Master Spec: Wave 1–4 ACs + DER results; Wave 5 **IMPLEMENTED ON MAIN** (#101) — AC-W5-1…23 **PASS**; Gap-edit 2 **IMPLEMENTED ON MAIN** (#111 + #112) — AC-GE2-1…34 **PASS**; HOLD **cleared**; **OPERATIONALLY ACCEPTED** / closed (Rekik formal closure YES) |
