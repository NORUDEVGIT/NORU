...
| **Gap-edit 2 Spec** | **Eng-ready / READY FOR ENGINEERING** — [Functional Spec §9](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted). Rekik APPROVED 2026-09-15. Additive Individual form + restriction. Does **not** reopen Waves 1–5 or Gap-edit 1. Module COMPLETE remains **NO**. |
...
>
> **Gap-edit 2 Spec Eng-ready / READY FOR ENGINEERING** (Rekik APPROVED 2026-09-15 via Hospitality Product Advisor). Additive Individual create/edit enrichment + blacklist/restricted. Tracking [#109](https://github.com/NORUDEVGIT/NORU/issues/109). Contract: [Functional Spec §9](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted) (AC-GE2-1…29). Does **not** reopen Waves 1–5. Does **not** reopen or rewrite Gap-edit 1 (§8 / #103 / #105). Migration **`0057`** Abel/PM gated. Module COMPLETE remains **NO**.
>
...
| Masters / relationships | **LIVE in code** (#97): Guest-owned Company / Group / TA (`guest_account_masters`) + `guest_account_links`. Wave 4 docs recon on `main` (#99). FO `company_name` / `group_name` remain stay **labels** unless consumed as master IDs. SET3 `companyRelationshipEnabled` remains a Setup **flag**. Sales & Events is a planned placeholder. Masters export / anonymise contact PII (Wave 5). | Same Guest-owned registers. Group account ≠ S&E blocks. Bill-to is an association — not folio routing while `transfersSupported: false`. |
...
| [Functional Spec §9 — Gap-edit 2](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted) | Individual form enrichment + blacklist/restricted — **Eng-ready / READY FOR ENGINEERING**. Rekik APPROVED 2026-09-15. AC-GE2-1…29. Additive; **not** implemented; does **not** reopen Waves 1–5 or rewrite Gap-edit 1. Migration `0057` Abel/PM gated. |
