...
| **Gap-edit 2 Spec** | **Eng-ready / READY FOR ENGINEERING** — [Functional Spec §9](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted). Rekik APPROVED 2026-09-15 (Scope C Linking amendment same day). Additive Individual form + restriction + after-save Linking. Does **not** reopen Waves 1–5 or Gap-edit 1. Module COMPLETE remains **NO**. |
...
>
> **Gap-edit 2 Spec Eng-ready / READY FOR ENGINEERING** (Rekik APPROVED 2026-09-15 via Hospitality Product Advisor). Additive Individual create/edit enrichment + blacklist/restricted + **Linking / Relationships** (Scope C amendment 2026-09-15). Tracking [#109](https://github.com/NORUDEVGIT/NORU/issues/109). Contract: [Functional Spec §9](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted) (AC-GE2-1…35). Does **not** reopen Waves 1–5. Does **not** reopen or rewrite Gap-edit 1 (§8 / #103 / #105). Migration **`0057`** Abel/PM gated. Module COMPLETE remains **NO**.
>
...
| [Functional Spec §9 — Gap-edit 2](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted) | Individual form enrichment + blacklist/restricted + Linking/Relationships — **Eng-ready / READY FOR ENGINEERING**. Rekik APPROVED 2026-09-15 (Scope C amendment same day). AC-GE2-1…35. Additive; **not** implemented; does **not** reopen Waves 1–5 or rewrite Gap-edit 1. Migration `0057` Abel/PM gated. |
| Issue [#109](https://github.com/NORUDEVGIT/NORU/issues/109) | Gap-edit 2 tracking issue — **OPEN**. TIP draft on the issue; **no code** until Rekik plan approval. Spec §9 is the Eng-ready contract. |
...
- **Gap-edit 2** (Individual form enrichment + blacklist/restricted + Linking/Relationships) is an **additive** follow-on — Spec **Eng-ready / READY FOR ENGINEERING** on [§9](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted) / [#109](https://github.com/NORUDEVGIT/NORU/issues/109). **Not** a Wave 1–5 defect and **not** a reopen. **Not** implemented. Migration `0057` Abel/PM gated. Does **not** rewrite Gap-edit 1.

---

## Closing

> **Wave 1 IMPLEMENTED ON MAIN** (#66 / #67). **Wave 2 IMPLEMENTED ON MAIN** (#72 / #76 / #79). **Wave 3 IMPLEMENTED ON MAIN** (#81 / #85 / #87 / #90). Wave 3 is OPERATIONALLY ACCEPTED / closed. Wave 4 **code LIVE on `main`** (#97). Wave 5 **IMPLEMENTED ON MAIN** (#101). Wave 5 is **OPERATIONALLY ACCEPTED** / engineering exited. Programme **READY FOR HOTEL UAT**. **Gap-edit 2 Spec Eng-ready / READY FOR ENGINEERING** ([§9](./specs/guest-profile-module.md#9-gap-edit-2--individual-form-enrichment--blacklist--restricted) / [#109](https://github.com/NORUDEVGIT/NORU/issues/109)) — additive; does not reopen Waves 1–5 or Gap-edit 1. Module COMPLETE remains **NO** until hotel UAT PASS + docs recon merge + Advisor module close.
>
