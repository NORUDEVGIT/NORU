...
| **Classification** | Functional Spec / programme — Waves 1–5 CURRENT on `main` for delivered cards; module **not** COMPLETE |
...
>
> **Wave 5 IMPLEMENTED ON MAIN** (Rekik 2026-09-14). PR [#101](https://github.com/NORUDEVGIT/NORU/pull/101) MERGED 2026-09-14T14:22:35Z. Issue [#98](https://github.com/NORUDEVGIT/NORU/issues/98) **CLOSED** completed 2026-09-14T17:18:19Z after Rekik formal closure / Advisor Outcome Review. ENGINEERING STATUS **COMPLETE / MERGED**. IMPLEMENTATION STATUS **PASS**. Independent QA **PASS**; Developer `tsc` + Wave 1–5 locks **82/82 PASS**. AC-W5-1…23 **PASS**. Non-prod 0054 **APPLY PASS** on `qcwptraosaudcbjasmul` (version `20260914142046`). Production 0054 **NOT applied** (Abel / PM gated). Do **not** claim Wave 5 unimplemented. The module is **not** COMPLETE — hotel UAT still required.
>
> Create once → use everywhere → enrich. The module is **COMPLETE** only after Waves 1–5 **and** hotel UAT. Do **not** treat Wave 1–5 merge as module COMPLETE.
>
...
| **5** | Comms / Activity + Privacy finish (export / anonymise / unmerge) for individuals and masters as appropriate | **COMPLETE / MERGED** — PR [#101](https://github.com/NORUDEVGIT/NORU/pull/101) MERGED 2026-09-14T14:22:35Z. Issue [#98](https://github.com/NORUDEVGIT/NORU/issues/98) **CLOSED** completed. IMPLEMENTATION STATUS **PASS**. OPERATIONALLY ACCEPTED / closed. | Full hub + privacy honesty delivered. Hotel UAT still required for **module COMPLETE** |
...
This overview plus the Functional Spec remain the programme record. Waves 1–5 are implemented on `main`. Wave 4 **code is LIVE on `main`** (#97); issue [#95](https://github.com/NORUDEVGIT/NORU/issues/95) **CLOSED** completed. Wave 5 **IMPLEMENTED ON MAIN** (#101); issue [#98](https://github.com/NORUDEVGIT/NORU/issues/98) **CLOSED** completed. The module is **not** COMPLETE until hotel UAT also passes.
...
| Issue [#98](https://github.com/NORUDEVGIT/NORU/issues/98) | Wave 5 tracking issue — **CLOSED** completed 2026-09-14T17:18:19Z. Rekik formal closure / Advisor Outcome Review. OPERATIONALLY ACCEPTED / closed. PR [#101](https://github.com/NORUDEVGIT/NORU/pull/101) Relates (did not Closes). |
...
| Issue | [#98](https://github.com/NORUDEVGIT/NORU/issues/98) **CLOSED** completed 2026-09-14T17:18:19Z. OPERATIONALLY ACCEPTED / closed after Rekik formal closure / Advisor Outcome Review. |
...
> **Wave 1 IMPLEMENTED ON MAIN** (#66 / #67). **Wave 2 IMPLEMENTED ON MAIN** (#72 / #76 / #79). **Wave 3 IMPLEMENTED ON MAIN** (#81 / #85 / #87 / #90). Wave 3 is OPERATIONALLY ACCEPTED / closed. Wave 4 **code LIVE on `main`** (#97). Wave 5 **IMPLEMENTED ON MAIN** (#101). Wave 5 is OPERATIONALLY ACCEPTED / closed. Module COMPLETE only after Waves 1–5 + hotel UAT.
>
