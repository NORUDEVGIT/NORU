...
| Guest Profile (`/restaurant/pms/guests`, `/restaurant/pms/guests/$guestId`) | [guests.md](./guests.md) — Waves 1–5 **IMPLEMENTED ON MAIN**; Wave 5 **OPERATIONALLY ACCEPTED**; Gap-edit 2 **IMPLEMENTED ON MAIN** (#111 + #112; HOLD **cleared**; Independent QA **PASS**); programme **READY FOR HOTEL UAT**; module **not** COMPLETE |
