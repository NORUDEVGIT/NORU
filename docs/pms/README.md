...
| Rate & Revenue (`/restaurant/pms/rates-revenue`) | [rate-revenue-phase1-audit.md](./rate-revenue-phase1-audit.md) (Prompt 1 audit) · [rate-revenue-responsibility.md](./rate-revenue-responsibility.md) (Prompt 2 ownership). **Not** UI-01–UI-40. |
