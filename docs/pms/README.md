...
| [Functional Spec — Guest Profile Module](./specs/guest-profile-module.md) | **Functional Spec** — Waves 1–5 Spec **ACCEPTED** + **IMPLEMENTED ON MAIN**. Wave 5 ENGINEERING STATUS **COMPLETE / MERGED**. Gap-edit 2 (**§9**) **Eng-ready / READY FOR ENGINEERING** (Rekik APPROVED 2026-09-15) — additive Individual form + restriction; does **not** reopen Waves 1–5 or Gap-edit 1. Module COMPLETE remains **NO**. |
