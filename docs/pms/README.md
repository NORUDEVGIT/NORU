...
| Rate & Revenue (`/restaurant/pms/rates-revenue`) | [rate-revenue-phase1-complete.md](./rate-revenue-phase1-complete.md) (**Phase 1 COMPLETE**) · [rate-revenue-phase1-audit.md](./rate-revenue-phase1-audit.md) · [rate-revenue-responsibility.md](./rate-revenue-responsibility.md) · [rate-revenue-workspace.md](./rate-revenue-workspace.md) · [rate-revenue-source-of-truth.md](./rate-revenue-source-of-truth.md) · [rate-revenue-phase2-audit.md](./rate-revenue-phase2-audit.md) · [rate-revenue-phase2-rate-change-domain.md](./rate-revenue-phase2-rate-change-domain.md). **Not** UI-01–UI-40 functionality. RR-P2-01 domain/history foundation is in place. |
