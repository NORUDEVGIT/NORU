...
| Rate & Revenue (`/restaurant/pms/rates-revenue`) | [rate-revenue-phase1-audit.md](./rate-revenue-phase1-audit.md) (Prompt 1 audit) · [rate-revenue-responsibility.md](./rate-revenue-responsibility.md) (ownership) · [rate-revenue-workspace.md](./rate-revenue-workspace.md) (Prompt 3 shell) · [rate-revenue-source-of-truth.md](./rate-revenue-source-of-truth.md) (Prompt 4 adapters). **Not** UI-01–UI-40 functionality. |
