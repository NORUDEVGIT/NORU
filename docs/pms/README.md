...
| [Functional Spec — Guest Profile Module](./specs/guest-profile-module.md) | **Functional Spec** — Waves 1–5 Spec **ACCEPTED** + **IMPLEMENTED ON MAIN**. Wave 5 ENGINEERING STATUS **COMPLETE / MERGED**. Gap-edit 2 (**§9**) **ACCEPTED for Engineering**; ENGINEERING **IMPLEMENTATION IN PROGRESS** on [#109](https://github.com/NORUDEVGIT/NORU/issues/109) (plan APPROVED with Linking **AC-GE2-9…13**). **Not** implemented / PASS / LIVE / COMPLETE. Does **not** reopen Waves 1–5 or Gap-edit 1. Migration `0056` Abel/PM gated. Module COMPLETE remains **NO**. |
...
| Guest Profile (`/restaurant/pms/guests`, `/restaurant/pms/guests/$guestId`) | [guests.md](./guests.md) — Waves 1–5 **IMPLEMENTED ON MAIN**; Wave 5 **OPERATIONALLY ACCEPTED**; Gap-edit 2 Spec **ACCEPTED for Engineering** / ENGINEERING **IN PROGRESS** (not implemented); programme **READY FOR HOTEL UAT**; module **not** COMPLETE |
