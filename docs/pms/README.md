...
| Guest Profile (`/restaurant/pms/guests`, `/restaurant/pms/guests/$guestId`) | [guests.md](./guests.md) — Waves 1–5 **IMPLEMENTED ON MAIN**; Wave 5 **OPERATIONALLY ACCEPTED**; Gap-edit 1 **IMPLEMENTED ON MAIN**; programme **READY FOR HOTEL UAT**; module **not** COMPLETE |
