...
| [Functional Spec — Guest Profile Module](./specs/guest-profile-module.md) | **Functional Spec** — Waves 1–5 Spec **ACCEPTED** + **IMPLEMENTED ON MAIN**. Wave 5 ENGINEERING STATUS **COMPLETE / MERGED**. Gap-edit 2 (**§9**) **Eng-ready / READY FOR ENGINEERING** (Rekik APPROVED 2026-09-15, Scope C Linking amendment same day) — additive Individual form + restriction + Wave 4 `guest_account_links` after save; does **not** reopen Waves 1–5 or Gap-edit 1. Module COMPLETE remains **NO**. |
...
| Guest Profile (`/restaurant/pms/guests`, `/restaurant/pms/guests/$guestId`) | [guests.md](./guests.md) — Waves 1–5 **IMPLEMENTED ON MAIN**; Wave 5 **OPERATIONALLY ACCEPTED**; Gap-edit 2 Spec **READY FOR ENGINEERING**; programme **READY FOR HOTEL UAT**; module **not** COMPLETE |
