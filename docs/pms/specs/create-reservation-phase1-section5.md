...
| **Prior / sibling sections** | [`create-reservation-phase1-section1.md`](./create-reservation-phase1-section1.md) (Context + Guest). Sections 2–4 are sibling Specs. Individual Associations amend (Spec [#137](https://github.com/NORUDEVGIT/NORU/pull/137) / impl [#139](https://github.com/NORUDEVGIT/NORU/pull/139) MERGED · IMPLEMENTATION PASS; [#138](https://github.com/NORUDEVGIT/NORU/issues/138) **OPEN** until Outcome Review) — does **not** reopen [#127](https://github.com/NORUDEVGIT/NORU/issues/127). This section **consumes** stay dates + room type from the create draft |
