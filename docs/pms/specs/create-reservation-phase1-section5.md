...
| **Prior / sibling sections** | [`create-reservation-phase1-section1.md`](./create-reservation-phase1-section1.md) (Context + Guest). Sections 2–4 are sibling Specs — **do not wait** on their merge. Individual Associations amend ([#137](https://github.com/NORUDEVGIT/NORU/pull/137)) may run in parallel — OK. This section **consumes** stay dates + room type from the create draft |
